    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\mjsoh\\Downloads\\Attendance-Management-system-using-face-recognition-master\\Attendance-Management-system-using-face-recognition-master\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:\\Users\\mjsoh\\Downloads\\Attendance-Management-system-using-face-recognition-master\\Attendance-Management-system-using-face-recognition-master\\Attendance(Manually)"'
                )
